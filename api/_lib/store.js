...
export async function aiUsedCount(sessionId, productId) {
  /* ★ 2026-08-27 (대표님 지시: "해가 바뀌면 다 리셋을 해야 되지 않나?
     ...
     이용권은 상품표의 기간)은 지금과 똑같이 유지된다.
     ★ 2026-09-07 — 이 주석이 "이용권(10회) … 어차피 7일이라 해를 넘길 일이 거의 없다"로
       옛 값에 멈춰 있었다. 지금은 **이용권 1년 · AI_QUOTA.pass = 2회**다.
       바뀐 점: 1년짜리라 **해를 넘기는 것이 오히려 보통**이다. 12월에 이용권을 산 분은
       1월 1일에 셈이 0으로 돌아가 그 해치를 다시 쓴다(상품별로 2회씩).
       그게 맞다 — 해가 바뀌면 세운과 나이가 달라져 글 자체가 달라지기 때문이다.
       다만 **원가를 볼 때는 이용권 한 장이 최대 (상품 3종 × 2회) × 걸치는 해의 수**임을
       기억할 것. AI_QUOTA를 손대려면 이 셈을 먼저 다시 하십시오.
